// função para criação de elementos
function novoElemento(tagName, className) {
  // cria um elemento passado como parametro o tagname
  // e armazena na const elem em seguida é adicionada uma calsse para
  // esse elemento e entao o elemento é retornado
